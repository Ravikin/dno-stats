...
function handleFile(file) {
  ...
  if (!file.name.endsWith('.json')) {
    showError('Invalid file type', 'Please upload a .json file exported by dno_stats.py.');
    return;
  }
...
function renderReport(stats) {
  ...
  html += `<div class="footer">Generated by dno_stats.py v${stats.extractorVersion} &mdash; ${stats.extractedAt} &mdash; Profile: ${profile.name}</div>`;
